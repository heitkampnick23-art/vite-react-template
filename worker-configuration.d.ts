/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 4da536146d29f3ac8fd99029f4298e64)
...
declare namespace Cloudflare {
	interface GlobalProps {
		...
		durableNamespaces: "CouncilRoom" | "LiveDoc" | "SandboxSession";
	}
	interface Env {
		...
		COUNCIL: DurableObjectNamespace<import("./src/worker/index").CouncilRoom>;
		LIVEDOC: DurableObjectNamespace<import("./src/worker/index").LiveDoc>;
		SANDBOX: DurableObjectNamespace<import("./src/worker/index").SandboxSession>;
		FILES: R2Bucket;
		BUILDS: R2Bucket;
		LOGS: R2Bucket;
		DB: D1Database;
